...
namespace SchoolOfIT.Lab2.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(SchoolOfITContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Courses != null ? 
                          ...
                          Problem("Entity set 'SchoolOfITContext.Courses'  is null.");
        }
        ...
        public ActionResult Details(int id)
        {
            ...
            var teachers = _context.Teachers
                .Where(t => t.Relations.Any(r => r.Courses.CourseId == id))
                .ToList();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SchoolOfITContext.Courses'  is null.");
            }
            var course = await _context.Courses.FindAsync(id);
            if (course != null)
            {
